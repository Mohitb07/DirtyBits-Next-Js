...
const useStyles = createStyles((theme) => ({
  ...
  link: {
    ...
    "&:hover": {
      backgroundColor:
        theme.colorScheme === "dark" ? colors.primary : theme.colors.gray[0],
    },
...
function HeaderResponsive() {
  ...
  const isAuth = useSelector((state: RootState) => state.userData.is_logged_in);
          ...
          {isAuth ? (
            ...
            <>
              ...
              <Link href="/auth/signup" passHref>
                <Button color="dark" variant="white" radius="xl">
                  Sign Up
                </Button>
              </Link>
            </>
